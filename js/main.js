...
window.matchMedia("(min-width: 1024px)").matches;{
    ...
    $("#open-menu-btn").click(function() {
        //$("nav").css("width", "400px");	
        $("nav").css({"width": "50%", "border-radius" : "30px", "z-index" : "100"})
    ...
    $("#close-menu-btn").click(function(){
        $("nav").css({"display": "block", "border-radius" : "30px", "width" : "5%"})
    ...
    window.matchMedia("(max-width: 1024px)").matches;{
        $("nav").css({"height": "0", "width" : "0"})
        $("#open-menu-btn").click(function() {
            //$("nav").css("height", "100%")
            $("nav").css({"height": "100%", "width" : "100%"})
...
/*========================== THEMES =============================*/
    ...
    if ($(".light-theme i").css("display", "block")) {
        $(".light-theme i").click(function() {
            $(".light-theme i").css("display", "none")
            $(".dark-theme i").css("display", "block")
        })
    } else ($(".light-theme i").css("display", "none"));{
        $(".dark-theme i").click(function() {
            $(".dark-theme i").css("display", "none")
            $(".light-theme i").css("display", "block")
        })
    }
